 ...
 * @author 乔
 */
@WebServlet(name = "RefPriComment", urlPatterns = {"/RefPriComment"})
public class RefPriComment extends HttpServlet {
...
//            HibernateMain.OpenSession();
            ...
            out.println("<liste_privateComments>");
           
            
            String numberneg = request.getParameter("numberN");
            List<Propose> listPro = HibernateMain.privateComments(Integer.parseInt(numberneg));            
            for (Propose pro : listPro) {
                out.print("<privateComment>");
                ...
                out.print("<privateCom>" + pro.getCommentpart() + "</privateCom>");
                out.print("</privateComment>");
            }
            out.println("</liste_privateComments>");
